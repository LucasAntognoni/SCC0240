...
class StaticReportGenerator {
    ...
    public static void generateReport1(String mod_name, String med_name, String prep_name) throws Exception
    {
    ...
    public static void generateReport2(String country_name) throws Exception
    {
        Class.forName("oracle.jdbc.driver.OracleDriver");
    ...
    public static void generateReport3() throws Exception
    {
         Class.forName("oracle.jdbc.driver.OracleDriver");
